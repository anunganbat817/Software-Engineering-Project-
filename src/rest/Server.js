        ...
        return new Promise(function (fulfill, reject) {
            try {
                ...
                that.rest.get("/datasets", function (req, res, next) {
                    Server.instance.listDatasets().then(function (result) {
                ...
                that.rest.put("/dataset/:id/:kind", function (req, res, next) {
                    ...
                    Server.instance.addDataset(req.params.id, data, req.params.kind).then(function (result) {
                        res.json(result.code, result.body);
                    }).catch(function (err) {
                        res.json(err.code, err.body);
                    });
                ...
                that.rest.del("/dataset/:id", function (req, res, next) {
                    Server.instance.removeDataset(req.params.id).then(function (result) {
                        res.json(result.code, result.body);
                    }).catch(function (err) {
                        res.json(err.code, err.body);
                    });
                ...
                that.rest.post("/query", function (req, res, next) {
                    Server.instance.performQuery(req.body).then(function (result) {
                        res.json(result.code, result.body);
                    }).catch(function (err) {
                        res.json(err.code, err.body);
                    });
...
Server.instance = new InsightFacade_1.default();
